...
class ImageProjection(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameters(
            namespace='',
            parameters=[
                ('camera.extrinsic_camera_calibration.top_x', 60, parameter_descriptor_top),
                ('camera.extrinsic_camera_calibration.top_y', 40, parameter_descriptor_top),
                ('camera.extrinsic_camera_calibration.bottom_x', 100, parameter_descriptor_bottom),
                ('camera.extrinsic_camera_calibration.bottom_y', 80, parameter_descriptor_bottom),
    ...
    def cbImageProjection(self, msg_img):
        ...
        pts_dst = np.array([[[700, 400], [2700, 400], [2700, 1000], [700, 1000]]])
